...
def mkfringeflat(inspec, inflat, outflat, do_shift=True, beg_shift=-0.5, end_shift=0.5,
    ...
    try:
        shifted = flt_hdulist[0].header['shifted']
    except KeyError:
        shifted = ""
    if "YE" in shifted:
        print(" ")
    ...
    opt_elem = sci_hdulist[0].header['opt_elem']

    nrows, ncols = sci_hdulist[1].data.shape
    bincols = sci_hdulist[0].header['binaxis1']
    binlines = sci_hdulist[0].header['binaxis2']

    fltbincols = flt_hdulist[0].header['binaxis1']
    fltbinlines = flt_hdulist[0].header['binaxis2']

    ltv1 = sci_hdulist[1].header['ltv1']

    sax0 = round(-ltv1) + 1
    sax1 = sax0 + ncols - 1

    centera2 = sci_hdulist[0].header['centera2']
    sizaxis2 = sci_hdulist[0].header['sizaxis2']

    ltv2 = 1 - centera2 - sizaxis2/2
    
    centera2 = flt_hdulist[0].header['centera2']
    sizaxis2 = flt_hdulist[0].header['sizaxis2']
    ...
    aperture = sci_hdulist[0].header['aperture']

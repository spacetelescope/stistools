...
class TestMktrace(BaseSTIS):
    ...
    def test_mktrace_t1(self, capsys):
        ...
        assert captured.out == "Traces were rotated by 0.006627 degrees \n" \
                               "\n" \
                               "trace is centered on row 509.247549\n"
    ...
    def test_mktrace_t2(self, capsys):
        ...
        # Compare results
        captured = capsys.readouterr()
        assert captured.out == "Traces were rotated by 0.031723 degrees \n" \
                               "\n" \
                               "trace is centered on row 893.705969\n"
